...
import (
	...
	appsv1 "github.com/pupimvictor/configmap-sync-operator/api/v1"
)
...
// +kubebuilder:rbac:groups=apps.pupimvictor.com,resources=configmapsyncs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apps.pupimvictor.com,resources=configmapsyncs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=apps.pupimvictor.com,resources=configmapsyncs/finalizers,verbs=update
...
func (r *ConfigMapSyncReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.Info("Reading ConfigMap in source namespace", "Namespace", configMapSync.Spec.SourceNamespace)
